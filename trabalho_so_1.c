...
pthread_t read[N_READER];
pthread_t write[N_WRITER];
...
void readFile(int sizeArray, int numbersArray[], char *filename){
...
int cc=1;
  ...
  /* Ler o conteudo do arquivo como array de inteiros de tamanho N_ARRAY */
    readFile(N_ARRAY, data_read, "f.txt");
